    ...
    <>
      ...
      <div className="lg:hidden fixed top-4 left-4 z-20">
        <button 
          ...
          className="p-2 rounded-md bg-gray-800 shadow-md"
        >
      ...
      >
        <div className="p-5">
          <div className="flex items-center mb-8">
            <span className="text-xl font-bold text-white">RegnovaAI</span>
          </div>
            ...
            <ul className="space-y-1">
              {menuItems.map((item, index) => (
                <li key={index}>
                  <Link 
                    href={item.href}
                    className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-dark-sidebar-hover text-gray-200"
                  >
